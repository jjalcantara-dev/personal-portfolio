  ...
  return (
    <div className="max-w-4xl mx-auto px-4 sm:px-6 py-12 sm:py-20 md:py-32">
      <article>
        ...
        <section className={`border-t ${clr.border.base} pt-12 mb-16`} aria-labelledby="form-heading">
          <ScrollAnimation animation="fade-up" delay={0}>
            <h2 id="form-heading" className={`${tx.h2} mb-8 ${clr.text.primary}`}>
        ...
        <section className={`border-t ${clr.border.base} pt-12`} aria-labelledby="contact-info-heading">
          ...
          <div className="space-y-8">
            <ScrollAnimation animation="fade-up" delay={0}>
              <div className="group transition-all duration-300 hover:translate-x-2">
                <h3 className={`text-sm font-medium ${clr.text.subtle} mb-3 uppercase tracking-wide`}>
                  {t.contact.email}
                </h3>
                <a
                  href="mailto:contact@jjalcantara.dev"
                  className={`text-lg ${clr.text.primary} hover:underline ${focusRing} inline-block transition-colors duration-300 group-hover:text-gray-800`}
                >
                  contact@jjalcantara.dev
                </a>
              </div>
            ...
            <ScrollAnimation animation="fade-up" delay={100}>
              <div className="group transition-all duration-300 hover:translate-x-2">
                ...
                <p className={`text-lg ${clr.text.primary} transition-colors duration-300 group-hover:text-gray-800`}>
